"""
  This code can be found at the BlinkyTile repository found here: https://github.com/Blinkinlabs/BlinkyTile/blob/master/python_example/blinkytape.py
"""
